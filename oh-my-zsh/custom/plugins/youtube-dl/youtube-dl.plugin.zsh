...
alias ytb-dlm-sub='youtube-dl -o "$HOME/Movies/Youtube-dl/%(title)s.%(ext)s" -f best -i --write-sub --sub-lang en, es'
alias ytb-dlm-asub='youtube-dl -o "$HOME/Movies/Youtube-dl/%(title)s.%(ext)s" -f best -i --write-auto-sub --sub-lang en, es'
